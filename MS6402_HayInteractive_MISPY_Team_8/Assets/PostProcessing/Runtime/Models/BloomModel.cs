...
namespace UnityEngine.PostProcessing
{
    ...
    public class BloomModel : PostProcessingModel
    {
        ...
        {
            [PPMinAttribute(0f), Tooltip("Strength of the bloom filter.")]
            public float intensity;

            [PPMinAttribute(0f), Tooltip("Filters out pixels under this level of brightness.")]
        ...
        public struct LensDirtSettings
        {
            ...
            [PPMinAttribute(0f), Tooltip("Amount of lens dirtiness.")]
            public float intensity;
